...
if __name__ == "__main__":
    ...
    model = net.create_posenet_3_separated_outs(
        'posenet.npy', True)  # GoogLeNet (Trained on Places)
    ...
    checkpointer = ModelCheckpoint(
        filepath="./models/test.h5", verbose=4, save_best_only=True, save_weights_only=True)
