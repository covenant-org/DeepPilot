...
class Recorder:
    def __init__(self):
        ...
        self.frame_cont = 0
        self.output_dir = self._mkdirnext()
        self.entry = 0
        self.takeoff = False
    ...
    def odom_callback(self, data):
        self.last_odom = data
        if self.takeoff and not self.start_recording:
    ...
    def callback(self, data):
        ...
        if len(self.q) == 6:
            ...
            with open(labels_path, "a") as f:
                f.write(
                    f"{imgname} {self.last_odom.linear.y} {self.last_odom.linear.x} {self.last_odom.angular.z} {self.last_odom.linear.z}\n"
                )
